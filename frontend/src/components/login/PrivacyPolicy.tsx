    ...
    return (
        <div className="privacy-policy">
            ...
            <p className="privacy-policy__text">
                This Privacy Policy outlines how we handle your personal information when you use our services. Your
            ...
            <ul className="privacy-policy__list">
                <li className="privacy-policy__list-item"><strong>Email Address:</strong> Your email address is used
                    solely for login purposes. It is not shared with any third parties.
                </li>
                <li className="privacy-policy__list-item"><strong>Password:</strong> When you create an account, your
                    password is securely encoded using bcrypt. This ensures that your password is protected and not
            ...
            <p className="privacy-policy__text">
                We take the security of your personal information seriously. We use industry-standard measures,
                including encryption and secure protocols, to protect your data from unauthorized access, use, or
                disclosure.
            </p>
