...
export default function ProfilePage() {
    ...
    const handleImageUpload = async (file: File) => {
        ...
        try {
            const response = await axiosInstance.post(`/user/upload/image/${user?.id}`, formData, {
    ...
    const handleDeleteImage = async () => {
        try {
            await axiosInstance.delete(`/user/upload/image/${user?.id}`);
            setUserImage("");
        } catch (error) {
                ...
                <div className="modal-overlay">
                    <div className="modal">
                        ...
                        <div className="modal__delete">
                            <button className="default-button modal__delete-button" onClick={confirmDeleteAccount}>
                                Delete
                            </button>
