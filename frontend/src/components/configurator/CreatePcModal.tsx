...
export default function CreatePCModal({isOpen, onClose, onSave}: Readonly<CreatePCModalProps>) {
        ...
        <div className="create-pc-modal__overlay">
            <div className="create-pc-modal">
                <div className="create-pc-modal__header">
                    <h2 className="create-pc-modal__title">Create Your PC</h2>
                ...
                <div className="create-pc-modal__body">
                    <div className="create-pc-modal__form-group">
                        <label className="create-pc-modal__label" htmlFor="pc-name">PC Name</label>
                        <input
                            id="pc-name"
                    ...
                    <div className="create-pc-modal__form-group">
                        <label className="create-pc-modal__label" htmlFor="pc-description">Description</label>
                        <textarea
                            id="pc-description"
                            className="create-pc-modal__input"
                            value={pcDescription}
