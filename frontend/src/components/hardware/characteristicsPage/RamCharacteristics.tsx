        ...
        <>
                ...
                <div className="modal-overlay">
                    <div className="modal">
                        ...
                        <div className="modal__body">
                            ...
                            <div className="modal__form-group">
                                <input className="modal__input" value={updatedType} onChange={(e) => setUpdatedType(e.target.value)} placeholder="Type"/>
                            </div>
                            <div className="modal__form-group">
                                <input className="modal__input" type="number" value={updatedMemorySize} onChange={(e) => setUpdatedMemorySize(e.target.value)} placeholder="Memory Size"/>
                            </div>
                        </div>
                        <div className="modal__footer">
                            <button className="default-button modal__delete-button" onClick={handleUpdate}>Update</button>
                            <button className="default-button modal__delete-button" onClick={() => setIsUpdateModalOpen(false)}>Close</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            {isModalOpen && (
                <div className="modal-overlay">
                    <div className="modal">
                        <div className="modal__header">
                            <h3 className="modal__title">Delete RAM</h3>
                            <button className="modal__close-btn" onClick={() => setIsModalOpen(false)}>×</button>
                        </div>
                        <div className="modal__body">
                            <p>Are you sure you want to delete this RAM?</p>
                        </div>
                        <div className="modal__footer">
